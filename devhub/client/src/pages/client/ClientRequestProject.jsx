      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl p-10 text-center max-w-md w-full shadow-sm border border-gray-100">
          ...
          <p className="text-gray-500 mb-7">
            Your project request has been submitted. I'll review it and get back to you within 24 hours.
          </p>
          <button
      ...
      <div className="max-w-2xl mx-auto px-8 py-10">
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
          ...
          <div className="bg-[#0f172a] px-8 py-8">
            <h1 className="text-3xl font-black text-white mb-1">Request a Project</h1>
